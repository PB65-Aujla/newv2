...
STRING_SESSION = getenv("STRING_SESSION", "BQGIzloALA_cNvosAFnLYH1f4PNBYvMaygeiHpeRLvAE-C2-PzWFSGB6PwK-rUxzElCG-ru5XVximIB9PvyvuaRREZ-401FolJmLJI2oiiuAJqys7UMF58PmgQWpcDMDf4JXer7NzcyHI7nkzXSoPqJXEDZKDwt0JRyoVfoRyM1d36YGLp8yP0tehcPzChXsddEsIsnzrztMsjJp40gjZTDKngHLsI3XSZcDX9sSfx7owTFMAOtzWJssu9utXTjqakoklED2MbupuTJ07EUeuUBJHp8XMV11vYawec2zzjY5c5txtyxm_KQgS9H1ky58J_i2KBv-gM0gRDxWLjWVzEeoNjgM6gAAAAHD6Dq1AA")
OWNER_ID = int(getenv("OWNER_ID", "8064364591"))
MONGO_URL = getenv("MONGO_URL", "mongodb+srv://aujla:aujla@jatt.sll2no4.mongodb.net/")
SUPPORT_GRP = getenv("SUPPORT_GRP", "pb65_aujla")
UPDATE_CHNL = getenv("UPDATE_CHNL", "TejinderAujla")
OWNER_USERNAME = getenv("OWNER_USERNAME", "User_PB65")
